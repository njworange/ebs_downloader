...
class ModuleAuto(PluginModuleBase):
    ...
    def process_command(
        ...
        match command:
            ...
            case "download_lookup":
                ...
                added, queued, skipped = self.queue_lookup_episodes(episodes)
    ...
    def queue_lookup_episodes(self, episodes: list[dict]) -> tuple[int, int, int]:
        added = 0
        skipped = 0
        queued = 0
        for ep in episodes:
